        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Menu Container - Flexbox Centered */}
                    <div className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className={`w-full max-w-[320px] rounded-2xl shadow-2xl pointer-events-auto ${isDark ? 'bg-gray-900 border border-gray-800' : 'bg-white border border-gray-200'
                                }`}
                        >
                            {/* Header */}
