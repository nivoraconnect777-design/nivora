...
import { X, ChevronLeft, ChevronRight, Eye, Heart, Send, MoreVertical, Trash2 } from 'lucide-react';
...
export default function StoryViewer({ initialUserIndex, storyUsers, onClose, isDark }: StoryViewerProps) {
    ...
    return ReactDOM.createPortal(
        <div className="fixed inset-0 z-[9999] bg-black flex items-center justify-center">
            ...
            {/* Main Content */}
            <div className="relative w-full h-full md:max-w-[380px] md:h-[90vh] md:rounded-2xl overflow-hidden bg-gray-900 shadow-2xl">
