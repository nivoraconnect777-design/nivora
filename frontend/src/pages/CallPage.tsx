...
export default function CallPage() {
    ...
    if (!call) {
        return (
            <div className={`flex items-center justify-center h-screen ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
    ...
    return (
        <StreamCall call={call}>
            <StreamTheme className={isDark ? 'dark' : 'light'}>
                <div className={`h-screen w-screen flex flex-col ${isDark ? 'bg-gray-900' : 'bg-gray-100'}`}>
                    <OneOnOneLayout />
