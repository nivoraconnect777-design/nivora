...
export default function SettingsPage() {
    ...
    return (
        <div className={`min-h-screen pb-20 ${isDark ? 'bg-gray-950 text-white' : 'bg-gray-50 text-gray-900'}`}>
            <div className="max-w-4xl mx-auto p-4 md:p-8 pt-20 md:pt-8 space-y-8">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="flex flex-col md:flex-row items-center md:justify-between gap-4">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors w-full md:w-auto ${isDark ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-100 hover:bg-gray-200'
                                    }`}
                            >
                                Edit Profile
                            </button>
